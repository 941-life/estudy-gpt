...
//       (files) => _processSharedData('media_stream', files: files),
//       onError: (err) => print('미디어 스트림 오류: $err'),
//     );

//     ReceiveSharingIntent.instance.getInitialMedia().then((files) {
//       if (files.isNotEmpty) {
//         _processSharedData('initial_media', files: files);
...
//       _processSharedData('method_channel', text: call.arguments);
//     }
//     return null;
//   }
...
class SharedIntentHandler {
  ...
  void dispose() {
    _mediaIntentSub.cancel();
    // _textIntentSub 제거됨에 따라 cancel() 호출 제거
  }
}
